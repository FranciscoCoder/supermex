    ...
    return(
        <div>
            <section>
                ...
                <div>
                    <p>
                        ...
                        tradiciones de nuestros ancestros.<br /><br />
            ...
            <section>
                <div>
                    <h2>APPCC</h2>
                    <h3>*Análisis de Peligros y Puntos de Control Crítico</h3>
                    <div>
                        <p>
                            ...
                            Además de nuestro laboratorio interno y de los empleados encargados del control de calidad, trabajamos con consultores y laboratorios externos para probar y verificar nuestros resultados.
                        </p>
                    </div>
                    <div>
                        <p>
                ...
                <div>
                    ...
                    <div>
                        <h2>IFS</h2>
                        <h3>* International Featured Standards</h3>
                        <div>
                            <p>
